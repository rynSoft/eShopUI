    ...
    return (
        <div>
                        ...
                        <div className="col-12">
                            ...
                            <div className="breadcrumb-wrapper vs-breadcrumbs d-sm-block d-none col-12">
                                <Breadcrumb className="ms-1">
                                    ...
                                    <BreadcrumbItem>
                                        <span> Panelden Ayırma Listesi</span>
                                    </BreadcrumbItem>
                                </Breadcrumb>
                            </div>
                        </div>
            ...
            <Card>
                ...
                <ExpandableTable noDataText="İş Emri Mevcut Değil" productionProcess={10}  searchValue={searchValue}/>
                </div>
            </Card>
        </div>
    );
...
export default DetachFromPanelList;
