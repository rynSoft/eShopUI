...
const QualityAutherizationList = () => {
    ...
    const loadData = () => {
        axios
            .get(process.env.REACT_APP_API_ENDPOINT + "api/QualityOperation/GetUserAutherizationList")
            .then((response) => {
    ...
    const NoDataConst = "Tamamlanan Kalite Mevcut Değil";
    ...
    const columns = [
...

        {
            ...
            color="danger"
            onClick={() => {
              ExportPdf(data, "tamamlananOperasyonlar", "TAMAMLANAN OPERASYONLAR LİSTESİ");
            }}
          >
            <Printer size={17} />
          </Button.Ripple>
           ...
           style={{ marginLeft: 5 }}
           onClick={() => {
             ExportExcel(searchValue.length ? filteredData : data, "tamamlananOperasyonlar", "TAMAMLANAN OPERASYONLAR LİSTESİ");
           }}
         >
             <Printer size={17} />
                    ...
                    <div className="row breadcrumbs-top">
                        <div className="col-12">
                            <h2 className="content-header-title float-start mb-0">
                                {"Tamamlanan Operasyonlar Listesi"}
                            </h2>
                            <div className="breadcrumb-wrapper vs-breadcrumbs d-sm-block d-none col-12">
                                <Breadcrumb className="ms-1">
                                    ...
                                    <BreadcrumbItem>
                                        <span> Tamamlanan Operasyonlar Listesi</span>
                                    </BreadcrumbItem>
                                </Breadcrumb>
                            </div>
                        </div>
...
export default QualityAutherizationList;
