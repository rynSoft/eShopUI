...
const QualityOperationList = () => {
    ...
    const loadData = () => {
        axios
            .get(process.env.REACT_APP_API_ENDPOINT + "api/QualityOperation/GetUserOperationList")
            .then((response) => {
    ...
    const columns = [
...

        {
            ...
            color="danger"
            onClick={() => {
              ExportPdf(data, "kaliteOperasyonListesi", "KALİTE OPERASYON LİSTESİ");
            }}
          >
            <Printer size={17} />
          </Button.Ripple>
                  ...
                  style={{ marginLeft: 5 }}
                  onClick={() => {
                    ExportExcel(searchValue.length ? filteredData : data, "kaliteOperasyonListesi", "KALİTE OPERASYON LİSTESİ");
                  }}
                >
                    <Printer size={17} />
                        ...
                        <div className="col-12">
                            ...
                            <div className="breadcrumb-wrapper vs-breadcrumbs d-sm-block d-none col-12">
                                <Breadcrumb className="ms-1">
                                    ...
                                    <BreadcrumbItem>
                                        <span> Kalite Operasyon Listesi</span>
                                    </BreadcrumbItem>
                                </Breadcrumb>
                            </div>
                        </div>
...
export default QualityOperationList;
